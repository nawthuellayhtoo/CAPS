	...
	<div class="row content">
		...
		<div class="col-sm-3">
			...
			<form:form method="POST"
				action="${pageContext.request.contextPath}/admin/course/add">

				<div class="form-group">
					<spring:message code="fieldLabel.courseId" />
					<form:input path="courseid" class="form-control" required="true"/>
				</div>

				<div class="form-group">
					<spring:message code="fieldLabel.courseName" />
					<form:input path="coursename" type="text" id="txt"
				...
				<div class="form-group">
					...
					<form:input type="number" path="credit" class="form-control" required="true" />
				</div>
