...
<div class="container-fluid">
	<div class="row content">
		...
		<div class="col-sm-9">
			...
			<c:set var="pageListHolder" value="${lecturerList}" scope="session" />
			<table class="table table-hover">
				<thead>
					<tr class="listHeading">
						<th><spring:message code="fieldLabel.lecturerId" /></th>
						<th><spring:message code="fieldLabel.lecturerFirstName" /></th>
						<th><spring:message code="fieldLabel.lecturerLastName" /></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="lecturer" items="${pageListHolder.pageList}">
						<tr class="listHeading">
							...
							<td><c:url
									value="/admin/lecturer/details/edit/${lecturer.lecturerid}.html"
									var="editurl" /> <a class="btn btn-success btn-sm"
								href="${editurl}"><spring:message code="caption.edit" /></a>
								&nbsp;&nbsp;
&nbsp;								<c:url
									value="/admin/lecturer/details/delete/${lecturer.lecturerid}.html"
					...
					<tr>
						<td><c:url value="/admin/lecturer/add"
								var="addurl" /> <a class="btn btn-success btn-sm"
							href="${addurl}"><spring:message code="caption.add.lecturer" /></a></td>
					</tr>
				</tbody>
			</table>
