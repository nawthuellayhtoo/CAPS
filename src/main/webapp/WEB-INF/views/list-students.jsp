...
<spring:url value="/admin/student/load" var="pageurl" />
<!-- navigation bar -->
...
<div class="container-fluid">
	<div class="row content">
		...
		<div class="col-sm-9">
			...
			<c:set var="pageListHolder" value="${studentList}" scope="session" />
			<table class="table table-hover">
				<thead>
					<tr class="listHeading">
						<th><spring:message code="fieldLabel.studentId" /></th>
						<th><spring:message code="fieldLabel.studentFirstName" /></th>
						<th><spring:message code="fieldLabel.studentLastName" /></th>
						<th><spring:message code="fieldLabel.studentGpa" /></th>
						<th><spring:message code="fieldLabel.studentEmail" /></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="student" items="${pageListHolder.pageList}">
						<tr class="listHeading">
							...
							<td>${student.email}</td>
							<td><c:url
									value="/admin/student/details/edit/${student.studentid}.html"
									var="editurl" /> <a class="btn btn-success btn-sm"
								href="${editurl}"><spring:message code="caption.edit" /></a></td>
							<td><c:url
									value="/admin/student/details/delete/${student.studentid}.html"
					...
					<tr>
						<td colspan="3"><c:url value="/admin/student/add"
								var="addurl" /> <a class="btn btn-success btn-sm"
							href="${addurl}"><spring:message code="caption.add.student" /></a></td>
					</tr>
				</tbody>
			</table>
